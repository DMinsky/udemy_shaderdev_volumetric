Shader "Holistic/RaymarchClouds"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float random(float3 value, float3 dotDir)
            {
                ...
                random = frac(sin(random) * 123574.43);
                return random;
            }
            
            float3 random3d(float3 value)
            {
                return float3(random(value, float3(12.88, 68.54, 37.78)),
                              random(value, float3(39.89, 26.54, 85.28)),
                              random(value, float3(76.89, 12.54, 8.88)));
            }
